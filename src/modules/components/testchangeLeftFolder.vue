                        ...
                        <div class="content-left-tree">
                            ...
                            <div class="content-left-tree-list">
                                ...
                                <testChangeLeftFolderItem :folderList="folderList" :menuList="menuList"
                                    @getDropdown="getDropdown" :showLeftFolder="showLeftFolder"></testChangeLeftFolderItem>
                        ...
                        <div class="content-left-tree">
                            ...
                            <div class="content-left-tree-list">
                                ...
                                <testChangeLeftFolderItem  
                                    :folderList="folderList"  :menuList="menuList" @getDropdown="getDropdown"  :showLeftFolder="showLeftFolder"></testChangeLeftFolderItem>
...
export default class contentManage extends Vue {
    ...
    @Prop({ require: true }) public titleList!: string[];
    @Prop({ require: true }) public folderName!: string;

    created(): void {
        console.log('文件夹', this.menuListTiTle, this.folderName, this.titleList);
        this.initMenuList();
// if(this.showleft){
//     this.folderDate.folderwightSpan=
// }else{

// }
    }
    // public folderDate = reactive({
    //     folderwightSpan: 3,
    //     ontentWightSpan:21
    // })
    public initMenuList() {
