<template>
  <div>
    ...
    <a-row :gutter="24" style="margin-top:30px">
      <a-col :push="1" :xs="6" :sm="6" :xl="3" :xxl="6">
        开始时间:
      </a-col>
      <a-col :xs="1" :sm="1" :xl="1" :xxl="1">
        <span style="color:#E8380D;height:6px;line-height: 6px;text-align: center;">
          *</span>
      </a-col>
    ...
    <!-- 红蓝方观点-pk类 -->
    <a-row :gutter="24" style="margin-top:30px" v-if="topicTypeValue === 'p'">
      <a-col :push="1" :xs="8" :sm="6" :xl="3" :xxl="6">
        请输入红方观点:
      </a-col>
      <a-col :xs="2" :sm="2" :xl="1" :xxl="1">
    ...
    <!-- 话题讨论类-话题结果选项 -->
    <a-row :gutter="24" style="margin-top:30px" v-if="topicTypeValue === 'd'">
      <a-col :push="1" :xs="8" :sm="6" :xl="3" :xxl="6">
        话题结果选项:
      </a-col>
      <a-col :xs="2" :sm="2" :xl="1" :xxl="1"></a-col>
      <a-col :xs="3" :sm="3" :xl="3" :xxl="2">
        <a-button @click="addTitleResult">新增</a-button>
      </a-col>
      <a-col :xs="12" :sm="12" :xl="8" :xxl="6">
    ...
    <a-row :gutter="24" style="margin-top:30px" v-if="topicTypeValue === 'd'">
      ...
      <a-col :xs="1" :sm="1" :xl="1" :xxl="1"></a-col>
      <a-col :xs="14" :sm="14" :xl="14" :xxl="14">
        <a-table
    ...
    <!-- 真相标题 -->
    <a-row :gutter="24" style="margin-top:30px" v-if="promptTruthValue === '1'">
      <a-col :push="1" :xs="8" :sm="6" :xl="3" :xxl="6">
        真相标题:
      </a-col>
      <a-col :xs="2" :sm="2" :xl="1" :xxl="1">
