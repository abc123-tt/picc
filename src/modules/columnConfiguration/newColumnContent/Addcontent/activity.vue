<template>
    <div>
            ...
            <div class="choose-select">
                <a-row :gutter="16">
                    ...
                    <a-col :span="10" class="row">
                        ...
                        <!-- <a-select @change="changeLabel" v-model:value="contentTags" style="width:200px;border-radius: 4px;" placeholder="默认第一项">
                     ...
                     <a-col :span="10" class="row">
                        <span>活动名称：</span>
                        <a-input style="width:53%;border-radius: 4px;" v-model:value="title" placeholder="请输入" />
                    </a-col>
                </a-row>
                <a-row :gutter="16">
                    <!-- 时间 -->
                    <a-col :span="10" class="box">
                        <span style="margin-left:5px">活动时间：</span>
                        <a-date-picker
            ...
            <a-table
                ...
                <template #bodyCell="{ record, column }">
                    <template v-if="column.key === 'operation'">
                        <div>
                            <a-button type="link" @click="editWords(value, row)" style="color: #2443bc;">详情</a-button>
                        </div>
                    </template>
                </template>
            </a-table>
        ...
        <a-modal v-model:visible="makeAddAdvertisingBoolean" >
			...
			<p style="padding: 30px 50px 30px 30px;">确定添加活动吗？</p>
        </a-modal>
    </div>
</template>
<script lang="ts">
...
//     @Ref('addForm') readonly addForm!: FormInstance;
    ...
    public editWords (value: any, row: any){
